 ...
 */
export class ArScreen extends Activity {
    /**
 ...
 */
export class ArScreenPanel extends ActivityPanel {
    /**
    ...
    buildVisualComponents() {
        ...
        console.log('this=', this.ps.project.basePath);
        //this.act.url = "https://www.youtube.com/embed/zcSHJRiT2F0";        
        const abc = this.act.abc['primary'];
        if (abc) {
            let url = this.ps.project.basePath + this.act.url;
            // style="z-index=20" ? <div style="z-index:20"></div>
            let ARcode = '<a-scene embedded vr-mode-ui="enabled: false;" arjs="debugUIEnabled: false;">' +
                '   <a-assets>' +
                '       <a-asset-item id="objetoAR" src="' + url + '"></a-asset-item>' +
                '   </a-assets>' +
                '   <a-marker>' +
                '       <a-entity gltf-model="#objetoAR" rotation="0 0 0" position="0 0 0" scale=".5 .5 .5"></a-entity>' +
                '   </a-marker>' +
                '   <a-entity camera></a-entity>' +
                '</a-scene>';
            this.$video = $(ARcode).appendTo(this.$div);
        }

        this.bg = ActiveBoxGrid.createEmptyGrid_AR(null, this,
...
Object.assign(ArScreenPanel.prototype, {
    /**
 ...
 * @type {class} */
ArScreen.Panel = ArScreenPanel;

// Register activity class
export default Activity.registerClass('@panels.ArScreen', ArScreen);