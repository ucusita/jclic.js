...
export class DoublePuzzlePanel extends ActivityPanel {
    ...
    buildVisualComponents() {
        console.log("DoublePuzzle");
        if (this.firstRun)
            super.buildVisualComponents();
        this.clear();

        //alert('Stopped');
        //this.iniciaParticulas();    //En este lugar no va porque no lo reconoce
     ...
     */
    nuevaExplosion(ev, position) {
        popParticula(ev, position);
    }
                    ...
                    if (!this.bc.active) {
                        ...
                        if (bx1 && bx2 && bx2.isInactive()) {
                            ...
                            if (bx1.getContent().isEquivalent(target, true)) {
                                ...
                                //this.nuevaExplosion(bx2.pos.x, bx2.pos.y);
                                this.nuevaExplosion(event, p);
                                //console.log(event);
                                //this.nuevaExplosion(120, 120);
