    ...
    load(project, sequence, activity) {
        ...
        if (activity) {
            ...
            if (act) {
                ...
                //console.info('act (610): ', act);
                this.project.activitySequence.checkCurrentActivity(act.name);
                actp = act.getActivityPanel(this);
                //console.info('actp (614): ', actp);
                actp.buildVisualComponents(); // AQUI CONSTRUYE EL HTML DEL OBJETO $DIV
                //console.info('actp (616): ', actp);
            } else {
        ...
        switch (mediaContent.type) {
            ...
            case 'PLAY_RECORDED_AUDIO':
                if (this.audioEnabled) {
                    ...
                    console.info(mediaContent);
                    if (amp)
                        action = () => {
                            log('info', 'Actividad de MULTIMEDIA en acción');
            ...
            case 'TTS':
                log('info', 'Actividad de TTS encontrada');
                break;
