...
export class Skin extends Container {
    ...
    constructor(ps, name = null, options = {}) {
        ...
        this.$infoHead = $('<div/>', { class: 'infoHead' })
            .append($('<div/>', { class: 'headTitle unselectableText' })
                ...
                .append($('<span/>').html('Cinco+Uno')))
            .append($('<p/>').css({ 'margin-top': 0, 'margin-left': '3.5em' })
                .append($('<a/>', { href: 'https://cincomasuno.ar' }).html('https://cincomasuno.ar'))
                .append($('<br>'))
                .append($('<span/>').html('2.1.14 (11-12-2021)')));
    ...
    setSkinSizes(full) {
        ...
        if (this.player && this.player.fullScreenChecked) {
            nilValue = 'inherit';
        }
